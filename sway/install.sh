...
echo -e "${green}Disabling hugepages to allow a dynamic setup${no_color}"
echo 0 | sudo tee /proc/sys/vm/nr_hugepages

echo -e "${blue}==================================================\n==================================================${no_color}"

bash <(curl -sL https://raw.githubusercontent.com/Qaddoumi/linconfig/main/sway/gpu-passthrough.sh) --size-of-pages $size_of_pages
