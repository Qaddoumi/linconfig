...
echo -e "${green}\n\n ******************* ARCH Packages Installation Script ******************* ${no_color}"
...
echo -e "${blue}--------------------------------------------------\n${no_color}"
yay -S --needed --noconfirm python-docx || echo -e "${red}Failed to install python-docx${no_color}" # Python library for creating and updating Microsoft Word (.docx) files
echo -e "${blue}--------------------------------------------------\n${no_color}"
...
echo -e "${blue}--------------------------------------------------\n${no_color}"
"${ESCALATION_TOOL}" pacman -S --needed --noconfirm ripgrep || echo -e "${red}Failed to install ripgrep${no_color}" # ripgrep search tool (needed for todo extension)
echo -e "${blue}--------------------------------------------------\n${no_color}"
