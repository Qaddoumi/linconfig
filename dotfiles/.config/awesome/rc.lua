...
-- local wibox = require("wibox") -- using quickshell for the bar
-- Theme handling library
local beautiful = require("beautiful")
-- Notification library
-- local naughty = require("naughty") -- im using dunst
...
-- Make sure awful is available globally for awesome-client
_G.awful = awful
_G.gears = gears
...
-- Using quickshell for the bar, wibox widgets commented out
...
awful.screen.connect_for_each_screen(function(s)
	...
	-- Wibox widgets commented out - using quickshell
...
client.connect_signal("manage", function (c)
	...
	if c.class == "quickshell" and not c.floating then
		...
		c:struts({ top = 30 })  -- Change 30 to your bar height
	end
...
awful.spawn.with_shell("/usr/bin/gnome-keyring-daemon --start --components=secrets,pkcs11,ssh")
awful.spawn.with_shell("/usr/lib/at-spi-bus-launcher --launch-immediately")
awful.spawn.with_shell("polkit-mate-authentication-agent-1")
awful.spawn.with_shell("picom -b")
awful.spawn.with_shell("/usr/bin/spice-vdagent")
...
awful.spawn.with_shell("xscreensaver-command -exit; sleep 3; xscreensaver -no-splash -quiet &")
