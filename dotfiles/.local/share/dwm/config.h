...
static const unsigned int enable_noborder     = 1;   /* toggles noborder feature {when one window is open} (0=disabled, 1=enabled) */
...
static const int showsystray                  = 0;   /* 0 means no systray - disable when using quickshell */
...
static const char *const autostart[] = {
    ...
    "sh", "-c", "sleep 2 && flameshot", NULL,
    "sh", "-c", "sleep 2 && copyq", NULL,
    "dunst", NULL,
    "sh", "-c", "xscreensaver-command -exit; sleep 3; xscreensaver -no-splash -quiet &", NULL,
    "sh", "-c", "feh --bg-fill ~/.local/share/dwm/wallpaper.png", NULL,
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_p,                      spawn,          SHCMD ("flameshot gui -p /media/drive/Pictures/")},
