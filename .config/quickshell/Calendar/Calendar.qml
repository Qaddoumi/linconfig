        ...
        Rectangle {
            ...
            Column {
                ...
                Rectangle {
                    ...
                    Timer {
                        interval: 1000
                        running: calendarRoot.isVisible
                        repeat: true
                ...
                Row {
                    ...
                    // Weather Section - Perfect square
                    Rectangle {
                        width: parent.height
                    ...
                    // Calendar Section
                    Rectangle {
                        width: parent.width - parent.height - 12  // Fill remaining space
                        height: parent.height
                        color: ThemeManager.surface1
                        radius: 16
                ...
                stdout: SplitParser {
                    onRead: data => {
                        ...
                        if (parts.length >= 5) {
                            ...
                            // Remove leading plus sign and trim whitespace from temperature
